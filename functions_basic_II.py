...
def length_and_value(size, value):
    new_list = []
    for num_slots in range(size):
        new_list.append(value)
    return new_list
print(length_and_value(4,7))
print(length_and_value(6,2))

# python functions_basic_II.py

# echo "# functions_basic_II" >> README.md
# git init
# git add README.md
# git commit -m "first commit"
# git branch -M main
# git remote add origin https://github.com/jcambray10/functions_basic_II.git
